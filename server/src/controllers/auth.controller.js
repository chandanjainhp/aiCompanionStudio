...
export const verifyOTP = asyncHandler(async (req, res) => {
  ...
  console.log(`📌 [auth.controller.verifyOTP] OTP received: "${otp}" (type: ${typeof otp}, length: ${String(otp).length})`);
...
export const forgotPassword = asyncHandler(async (req, res) => {
  ...
  console.log(`🔐 [auth.controller.forgotPassword] Password reset request for ${email}`);
...
export const resetPassword = asyncHandler(async (req, res) => {
  ...
  console.log(`🔐 [auth.controller.resetPassword] Password reset for ${email}`);

  if (!email || !token || !password) {
    throw new BadRequestError('Email, reset token, and new password are required');
  }
