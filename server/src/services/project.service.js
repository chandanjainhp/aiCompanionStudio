...
export const updateProject = async (projectId, userId, data) => {
  ...
  const updatedProject = await prisma.project.update({
    ...
    data: {
      ...
      ...(data.coreMemory !== undefined && { coreMemory: data.coreMemory }),
      // Manually update memoryUpdatedAt when coreMemory is manually set (not auto-update)
      ...(data.coreMemory !== undefined && { memoryUpdatedAt: new Date() }),
    },
    select: {
      id: true,
      name: true,
