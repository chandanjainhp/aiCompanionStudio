...
export default function LandingPage() {
  ...
  return <div ref={containerRef} className="min-h-screen bg-[#0B0F1A] text-white overflow-hidden">
            {/* Animated Background */}
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0B0F1A]/80 backdrop-blur-xl border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span className="font-bold text-sm sm:text-xl truncate">AI Companion Studio</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-4">
                        <Link to="/login">
                            <Button variant="ghost" className="text-white/80 hover:text-white h-9 px-2 sm:px-3 text-xs sm:text-base">
                                Sign In
                            </Button>
                        </Link>
                        <a href="https://github.com/chandanjainhp/aiCompanionStudio" target="_blank" rel="noopener noreferrer" className="hidden sm:block">
                            <Button variant="ghost" className="text-white/80 hover:text-white gap-2 h-9 px-3">
                                <GitHubIcon sx={{
                fontSize: 20
              }} />
                        ...
                        <Link to="/register">
                            <Button className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 h-9 px-3 sm:px-4 text-xs sm:text-base">
      ...
      opacity
        ...
        y: -mousePosition.y
          ...
          duration: 0.8
        }} className="inline-flex flex-col sm:flex-row items-center gap-2 px-4 py-2 rounded-2xl sm:rounded-full bg-white/5 border border-white/10 backdrop-blur-sm mb-8">
                        <div className="flex items-center gap-2">
                            <AutoAwesomeIcon sx={{
              fontSize: 16
            }} className="text-blue-400" />
                            <span className="px-2 py-0.5 rounded-full bg-blue-500/20 border border-blue-500/30 text-[10px] font-bold text-blue-300 uppercase tracking-wide">New</span>
                        </div>
                        <span className="text-xs sm:text-sm font-medium text-white/80 text-center">Powered by Advanced AI OpenRoute API</span>
                    </motion.div>
          ...
          duration: 0.8,
          delay: 0.2
        }} className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent leading-tight">
                        Custom AI Agents
                        <br />
                        For Your Workflow
                    </motion.h1>
          ...
          duration: 0.8,
          delay: 0.4
        }} className="text-lg md:text-2xl text-white/60 mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          delay: 0.6
                        ...
                        <Link to="/register" className="w-full sm:w-auto">
                            <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white px-8 py-6 text-lg rounded-xl shadow-2xl shadow-blue-500/25">
                                Start Building Free
                                <ArrowForwardIcon sx={{
                fontSize: 20
              }} className="ml-2" />
                        ...
                        <Link to="/dashboard" className="w-full sm:w-auto">
                            <Button size="lg" variant="outline" className="w-full sm:w-auto border-white/20 hover:bg-white/10 text-white px-8 py-6 text-lg rounded-xl">
                                View Demo
                            </Button>
                        </Link>
                    </motion.div>
          ...
          once: true
                        ...
                        <h2 className="text-3xl md:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
                            Everything You Need
                        </h2>
            ...
            y: -5,
            scale: 1.02
          }} className="group relative p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
          ...
          once: true
        }} className="relative p-6 md:p-12 rounded-3xl bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-white/10 backdrop-blur-xl overflow-hidden">
