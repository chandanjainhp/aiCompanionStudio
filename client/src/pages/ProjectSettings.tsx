...
const models: { value: AIModel; label: string }[] = [
  ...
  { value: 'anthropic/claude-3-opus-20250219', label: 'Claude 3 Opus (Anthropic)' },
  { value: 'anthropic/claude-3-sonnet-20250229', label: 'Claude 3 Sonnet (Anthropic)' },
  { value: 'meta-llama/llama-3.1-405b', label: 'Llama 3.1 405B (Meta)' },
...
export default function ProjectSettings() {
  ...
  const { currentProject, setCurrentProject, updateProject, deleteProject, fetchProject, isLoading } =
    useProjectsStore();
  ...
  useEffect(() => {
    if (currentProject) {
      reset({
        ...
        model: (currentProject.model as AIModel),
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={model}
                      onValueChange={(value) => setValue('model', value as AIModel, { shouldDirty: true })}
                    >
                      <SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {promptTemplates.map((template) => (
                      <button
                        ...
                        className="flex items-start gap-3 p-4 rounded-lg border border-border bg-card hover:bg-accent hover:border-primary/50 transition-all text-left"
                      >
