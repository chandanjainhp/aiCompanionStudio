...
export function SessionTimeoutWarning() {
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-orange-500 text-white p-4 rounded-lg shadow-lg max-w-sm z-50">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2 mt-3">
            <button
              ...
              className="text-xs font-medium px-2 py-1 bg-orange-600 hover:bg-orange-700 rounded"
            >
              Dismiss
            </button>
          </div>
