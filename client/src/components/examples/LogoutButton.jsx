...
export function LogoutButton() {
  ...
  return <div className="flex flex-col gap-2">
      <button onClick={handleLogout} disabled={isLoading} className="px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg font-medium transition">
