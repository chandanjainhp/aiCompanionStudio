        ...
        <>
                    ...
                    <div className="hidden lg:flex items-center gap-8 flex-1 max-w-2xl">
                        ...
                        <div className="relative flex-1 max-w-md">
                            ...
                            <Input
                                ...
                                className="pl-10 h-9 bg-white/5 border-white/10 focus:border-blue-500/50 focus:bg-white/[0.07] rounded-lg"
                            />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant="ghost"
                                    className="h-9 px-2 rounded-lg hover:bg-white/5 gap-2"
                                >
                                    <UserAvatar
                        ...
                        <Button
                            variant="ghost"
                            size="icon"
                            className="lg:hidden h-9 w-9 rounded-lg hover:bg-white/5"
            ...
            {mobileMenuOpen && (
                ...
                >
                    ...
                    {/* Menu Panel */}
                    <div className="absolute right-0 top-16 bottom-0 w-80 bg-[#0B0F1A] border-l border-white/10 p-6 overflow-y-auto">
                        ...
                        <div className="mt-6">
                            <CreateProjectModal>
                                <Button className="w-full gap-2 bg-gradient-to-r from-blue-600 to-cyan-500">
                                    <Plus className="w-4 h-4" />
                                    New Project
                                </Button>
                            </CreateProjectModal>
